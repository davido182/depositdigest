              ...
              <Tabs defaultValue="revenue" className="w-full">
                ...
                <TabsContent value="revenue" className="space-y-6">
                  <Card className="relative overflow-hidden bg-white border border-gray-200 shadow-xl p-6">
                    <h3 className="text-lg font-medium mb-4 text-gray-800">💰 Ingresos Reales del Año {new Date().getFullYear()}</h3>
                    ...
                    <Card className="relative overflow-hidden bg-white border border-gray-200 shadow-xl p-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <p className="text-xl font-medium text-gray-900">76%</p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-600">Duración Promedio del Contrato</p>
                          <p className="text-xl font-medium text-gray-900">14 meses</p>
                        </div>
                      </div>
                    </Card>
                  </div>
